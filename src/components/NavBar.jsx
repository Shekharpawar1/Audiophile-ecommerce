...
const NavBar = () => {
  ...
  return (
    <div className="nav">
      <div className="nav__hamburger" onClick={() => navigate("/grid")}>
      ...
      <nav className="navbar">
        <ul className="nav__list">
          <li className="nav__list--item">
            <NavLink to="/" className={navItem.navLink}>
              HOME
            </NavLink>
          </li>
          <li className="nav__list--item">
            <NavLink to="/headphone" className={navItem.navLink}>
              HEADPHONES
            </NavLink>
          </li>
          <li className="nav__list--item">
            <NavLink to="/speaker" className={navItem.navLink}>
              SPEAKERS
            </NavLink>
          </li>
          <li className="nav__list--item">
            <NavLink to="/earphone" className={navItem.navLink}>
              EARPHONES
            </NavLink>
          </li>
        </ul>
